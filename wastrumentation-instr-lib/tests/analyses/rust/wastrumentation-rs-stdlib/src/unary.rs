...
// IDX VARIANT           CONVERSION IMPLEMENTATION
    ...
    14 F32Nearest        |o: WasmValue| WasmValue::F32(libm::roundf(o.as_f32())),
    ...
    21 F64Nearest        |o: WasmValue| WasmValue::F64(libm::round(o.as_f64())),
    ...
    54 F32ReinterpretI32 |o: WasmValue| WasmValue::F32(f32::from_bits(o.as_i32().try_into().unwrap())),
    55 F64ReinterpretI64 |o: WasmValue| WasmValue::F64(f64::from_bits(o.as_i64().try_into().unwrap())),
