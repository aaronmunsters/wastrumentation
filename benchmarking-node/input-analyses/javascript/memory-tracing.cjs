// source for CircularBuffer: https://github.com/tomsmeding/circular-buffer/blob/ad6e689797a6adf45af1bd83c449bd80fbeefb6f/index.js
{
	////////////////////////////
	...
	const CIRCULAR_BUFFER_CAPACITY = 1_000_000;
	const accesses /* : [{func, instr, addr, write: bool}] */ = new CircularBuffer(CIRCULAR_BUFFER_CAPACITY);;

	function access({func, instr}, {addr, offset}, write) {
		accesses.enq({func, instr, addr: addr+offset, write});
	};
