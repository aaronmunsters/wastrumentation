...
advice! { apply         (func: WasmFunction, args: MutDynArgs, ress: MutDynResults) {
/*   */ args.update_each_arg(|_index, v| v.denan());
/*   */ func.apply();
/*   */ ress.update_each_res(|_index, v| v.denan());
} }

advice! { unary generic (opt: UnaryOperator, opnd: WasmValue, _l: Location) {
/*   */ opt.apply(opnd.denan()).denan() } }
advice! { binary generic (opt: BinaryOperator, l_opnd: WasmValue, r_opnd: WasmValue, _l: Location) {
/*   */ opt.apply(l_opnd.denan(), r_opnd.denan()).denan() } }
advice! { const_ generic (v: WasmValue, _l: Location) {
/*   */ v.denan() } }
advice! { local generic (v: WasmValue, _i: LocalIndex, _l: LocalOp, _l: Location) {
/*   */ v.denan() } }
advice! { global generic (v: WasmValue, _i: GlobalIndex, _g: GlobalOp, _l: Location) {
/*   */ v.denan() } }
advice! { load generic (i: LoadIndex, o: LoadOffset, op: LoadOperation, _l: Location) {
/*   */ op.perform(&i, &o).denan() } }
advice! { store generic (i: StoreIndex, v: WasmValue, o: StoreOffset, op: StoreOperation, _l: Location) {
/*   */ op.perform(&i, &v.denan(), &o); } }
